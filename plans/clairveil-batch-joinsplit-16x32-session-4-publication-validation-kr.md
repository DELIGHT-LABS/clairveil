...
- review scope: `e427370..7e27721ebdaa0a0c9591002be25f432026c64310`
- 시작 HEAD: `b2fa95661590f681d268885c7dfdf7e9af3581ba` (`docs: record Session 3B completion`)
- 최종 HEAD: `7e27721ebdaa0a0c9591002be25f432026c64310` (Pass A~I, 전체 regression, canonical complete release generation/external verification, raw/extracted exact archive mode와 private-file replacement를 검증한 immutable implementation snapshot; 이후 commit은 publication record만 변경함)

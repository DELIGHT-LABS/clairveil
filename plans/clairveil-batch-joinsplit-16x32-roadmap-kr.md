...
| --- | --- | --- | --- | --- | --- |
| 1. 현재 보안 수정 | Complete historical Gate 1; 2x2 security evidence re-entry 필요 | `e427370` | `14d85f5` | unit/proto/전체 Go/examples/vulncheck/localnet/privacy E2E/payroll live/release-check/bulk readiness/fuzz/release-pack, review-fix 및 prepared-transfer canonical key 회귀 검증 통과 | 2026-07-12 재검증에서 2x2 blinding exact-reuse circuit constraint와 exact duplicate inflation witness가 미완료임을 확인함. Current Critical/High는 발견하지 않았지만 security-relevant Medium 2건을 닫기 전 Gate 1 증거를 publication에 재사용할 수 없음. Dependency/formal setup/audit risk도 유지 |
...
| 4. 독립 검증/공개 gate | **BLOCKED — Not publication-ready** | `d45f0753c16571743f630599776c9cd498d1e8c9` 재검증 시작 | BLOCKED record `773e97d5dac68c485479cfe8de40c1d002cb5240` | `e427370..d45f0753c16571743f630599776c9cd498d1e8c9`에서 Gate 3B를 먼저 재구성해 FAIL로 판정했으므로 Pass A~I, fresh benchmark/localnet/full release gate를 시작하지 않음. 보조 independent KAT와 unit 경계만 통과했으며 Gate 3B를 대체하지 않음 | Gate 3B High 2건·security-relevant Medium 2건에 더해 live failover evidence, 2x2 circuit blinding reuse(Session 2/3A 재진입), exploit-shaped duplicate regression의 security-relevant Medium 3건이 unresolved. 합계 Critical 0/High 2/security Medium 5이며 `PUBLICATION_READY_EXPERIMENTAL` 선언 불가 |

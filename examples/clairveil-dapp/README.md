...
| `POST /v1/prover/deposit` | configured proxy | Exact proxy to `CLAIRVEIL_DEPOSIT_PROOF_URL`; never derived from `proverUrl` |
| `POST /v1/prover/transfer` / `withdraw` | all | Same-origin proxy to the configured transfer/withdraw prover |

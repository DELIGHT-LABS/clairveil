...
required_files=(
	...
	"docs/clairveil-bulk-transfer-prover-scale-option-kr.md"
	"docs/clairveil-bulk-transfer-strategy-kr.md"
	"docs/clairveil-bulk-transfer-time-simulation-kr.md"
	"docs/clairveil-note-reservation-design-kr.md"
	"docs/clairveil-scan-optimization-implementation-plan.md"
	"docs/clairveil-scan-optimization-implementation-plan-kr.md"

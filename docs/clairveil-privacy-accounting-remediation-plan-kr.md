...
현재 상태는 **P0 remediation planning**입니다. 아래 항목은 배포 전 반드시 해결해야 하며, 이미 public 또는 production-like network에서 사용 중인 경우 privacy module deposit, transfer, withdraw를 임시 중단하고 state exposure를 먼저 평가해야 합니다.
...
- `cmd/clairveil-setup`
- `x/privacy/zk/*`
- `privacy_spend_*`, `privacy_joinsplit_*` artifacts

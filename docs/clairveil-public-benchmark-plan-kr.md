...
- `cmd/clairveil-userlatency`는 trace를 flow 단위로 집계해 `prepare_latency_ms`, `proof_latency_ms`, `time_to_submit_ms`, `submit_ready_ms`, `total_latency_ms`, `timeout_rate`, `cancel_rate`, optional inclusion latency를 structured summary로 출력합니다.

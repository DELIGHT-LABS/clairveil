...
| Browser 제품 경계 | [WebApp scope](clairveil-web-app-scope.md) | [WebApp scope](clairveil-web-app-scope-kr.md) |
| Browser API와 lifecycle | [WebApp integration](clairveil-web-app-integration.md) | [WebApp integration](clairveil-web-app-integration-kr.md) |
| Browser storage와 restart | [WebApp storage and recovery](clairveil-web-app-storage-recovery.md) | [WebApp storage and recovery](clairveil-web-app-storage-recovery-kr.md) |

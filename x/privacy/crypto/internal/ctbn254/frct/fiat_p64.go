...
//
// Autogenerated: './fiat_crypto_v0.1.6_macos_arm64' word-by-word-montgomery --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name ” --doc-text-before-type-name ” --package-name bn254fr ” 64 21888242871839275222246405745257275088548364400416034343698204186575808495617 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
//
// curve description (via package name): bn254fr
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x20 uint64
	_, x20 = bits.Mul64(x11, 0xc2e1f593efffffff)
	var x22 uint64
	var x23 uint64
	x23, x22 = bits.Mul64(x20, 0x30644e72e131a029)
	var x24 uint64
	var x25 uint64
	x25, x24 = bits.Mul64(x20, 0xb85045b68181585d)
	var x26 uint64
	var x27 uint64
	x27, x26 = bits.Mul64(x20, 0x2833e84879b97091)
	var x28 uint64
	var x29 uint64
	x29, x28 = bits.Mul64(x20, 0x43e1f593f0000001)
	var x30 uint64
	var x31 uint64
	...
	var x72 uint64
	_, x72 = bits.Mul64(x62, 0xc2e1f593efffffff)
	var x74 uint64
	var x75 uint64
	x75, x74 = bits.Mul64(x72, 0x30644e72e131a029)
	var x76 uint64
	var x77 uint64
	x77, x76 = bits.Mul64(x72, 0xb85045b68181585d)
	var x78 uint64
	var x79 uint64
	x79, x78 = bits.Mul64(x72, 0x2833e84879b97091)
	var x80 uint64
	var x81 uint64
	x81, x80 = bits.Mul64(x72, 0x43e1f593f0000001)
	var x82 uint64
	var x83 uint64
	...
	var x125 uint64
	_, x125 = bits.Mul64(x115, 0xc2e1f593efffffff)
	var x127 uint64
	var x128 uint64
	x128, x127 = bits.Mul64(x125, 0x30644e72e131a029)
	var x129 uint64
	var x130 uint64
	x130, x129 = bits.Mul64(x125, 0xb85045b68181585d)
	var x131 uint64
	var x132 uint64
	x132, x131 = bits.Mul64(x125, 0x2833e84879b97091)
	var x133 uint64
	var x134 uint64
	x134, x133 = bits.Mul64(x125, 0x43e1f593f0000001)
	var x135 uint64
	var x136 uint64
	...
	var x178 uint64
	_, x178 = bits.Mul64(x168, 0xc2e1f593efffffff)
	var x180 uint64
	var x181 uint64
	x181, x180 = bits.Mul64(x178, 0x30644e72e131a029)
	var x182 uint64
	var x183 uint64
	x183, x182 = bits.Mul64(x178, 0xb85045b68181585d)
	var x184 uint64
	var x185 uint64
	x185, x184 = bits.Mul64(x178, 0x2833e84879b97091)
	var x186 uint64
	var x187 uint64
	x187, x186 = bits.Mul64(x178, 0x43e1f593f0000001)
	var x188 uint64
	var x189 uint64
	...
	var x206 uint64
	var x207 uint64
	x206, x207 = bits.Sub64(x197, 0x43e1f593f0000001, uint64(0x0))
	var x208 uint64
	var x209 uint64
	x208, x209 = bits.Sub64(x199, 0x2833e84879b97091, uint64(uint1(x207)))
	var x210 uint64
	var x211 uint64
	x210, x211 = bits.Sub64(x201, 0xb85045b68181585d, uint64(uint1(x209)))
	var x212 uint64
	var x213 uint64
	x212, x213 = bits.Sub64(x203, 0x30644e72e131a029, uint64(uint1(x211)))
	var x215 uint64
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x9 uint64
	var x10 uint64
	x9, x10 = bits.Sub64(x1, 0x43e1f593f0000001, uint64(0x0))
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Sub64(x3, 0x2833e84879b97091, uint64(uint1(x10)))
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Sub64(x5, 0xb85045b68181585d, uint64(uint1(x12)))
	var x15 uint64
	var x16 uint64
	x15, x16 = bits.Sub64(x7, 0x30644e72e131a029, uint64(uint1(x14)))
	var x18 uint64
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x10 uint64
	var x11 uint64
	x10, x11 = bits.Add64(x1, (x9 & 0x43e1f593f0000001), uint64(0x0))
	var x12 uint64
	var x13 uint64
	x12, x13 = bits.Add64(x3, (x9 & 0x2833e84879b97091), uint64(uint1(x11)))
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(x5, (x9 & 0xb85045b68181585d), uint64(uint1(x13)))
	var x16 uint64
	x16, _ = bits.Add64(x7, (x9 & 0x30644e72e131a029), uint64(uint1(x15)))
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	x1 := arg1[0]
	var x2 uint64
	_, x2 = bits.Mul64(x1, 0xc2e1f593efffffff)
	var x4 uint64
	var x5 uint64
	x5, x4 = bits.Mul64(x2, 0x30644e72e131a029)
	var x6 uint64
	var x7 uint64
	x7, x6 = bits.Mul64(x2, 0xb85045b68181585d)
	var x8 uint64
	var x9 uint64
	x9, x8 = bits.Mul64(x2, 0x2833e84879b97091)
	var x10 uint64
	var x11 uint64
	x11, x10 = bits.Mul64(x2, 0x43e1f593f0000001)
	var x12 uint64
	var x13 uint64
	...
	var x32 uint64
	_, x32 = bits.Mul64(x26, 0xc2e1f593efffffff)
	var x34 uint64
	var x35 uint64
	x35, x34 = bits.Mul64(x32, 0x30644e72e131a029)
	var x36 uint64
	var x37 uint64
	x37, x36 = bits.Mul64(x32, 0xb85045b68181585d)
	var x38 uint64
	var x39 uint64
	x39, x38 = bits.Mul64(x32, 0x2833e84879b97091)
	var x40 uint64
	var x41 uint64
	x41, x40 = bits.Mul64(x32, 0x43e1f593f0000001)
	var x42 uint64
	var x43 uint64
	...
	var x62 uint64
	_, x62 = bits.Mul64(x56, 0xc2e1f593efffffff)
	var x64 uint64
	var x65 uint64
	x65, x64 = bits.Mul64(x62, 0x30644e72e131a029)
	var x66 uint64
	var x67 uint64
	x67, x66 = bits.Mul64(x62, 0xb85045b68181585d)
	var x68 uint64
	var x69 uint64
	x69, x68 = bits.Mul64(x62, 0x2833e84879b97091)
	var x70 uint64
	var x71 uint64
	x71, x70 = bits.Mul64(x62, 0x43e1f593f0000001)
	var x72 uint64
	var x73 uint64
	...
	var x92 uint64
	_, x92 = bits.Mul64(x86, 0xc2e1f593efffffff)
	var x94 uint64
	var x95 uint64
	x95, x94 = bits.Mul64(x92, 0x30644e72e131a029)
	var x96 uint64
	var x97 uint64
	x97, x96 = bits.Mul64(x92, 0xb85045b68181585d)
	var x98 uint64
	var x99 uint64
	x99, x98 = bits.Mul64(x92, 0x2833e84879b97091)
	var x100 uint64
	var x101 uint64
	x101, x100 = bits.Mul64(x92, 0x43e1f593f0000001)
	var x102 uint64
	var x103 uint64
	...
	var x117 uint64
	var x118 uint64
	x117, x118 = bits.Sub64(x110, 0x43e1f593f0000001, uint64(0x0))
	var x119 uint64
	var x120 uint64
	x119, x120 = bits.Sub64(x112, 0x2833e84879b97091, uint64(uint1(x118)))
	var x121 uint64
	var x122 uint64
	x121, x122 = bits.Sub64(x114, 0xb85045b68181585d, uint64(uint1(x120)))
	var x123 uint64
	var x124 uint64
	x123, x124 = bits.Sub64(x116, 0x30644e72e131a029, uint64(uint1(x122)))
	var x126 uint64
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x5 uint64
	var x6 uint64
	x6, x5 = bits.Mul64(x4, 0x216d0b17f4e44a5)
	var x7 uint64
	var x8 uint64
	x8, x7 = bits.Mul64(x4, 0x8c49833d53bb8085)
	var x9 uint64
	var x10 uint64
	x10, x9 = bits.Mul64(x4, 0x53fe3ab1e35c59e3)
	var x11 uint64
	var x12 uint64
	x12, x11 = bits.Mul64(x4, 0x1bb8e645ae216da7)
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Add64(x12, x9, uint64(0x0))
	var x15 uint64
	...
	x17, x18 = bits.Add64(x8, x5, uint64(uint1(x16)))
	var x19 uint64
	_, x19 = bits.Mul64(x11, 0xc2e1f593efffffff)
	var x21 uint64
	var x22 uint64
	x22, x21 = bits.Mul64(x19, 0x30644e72e131a029)
	var x23 uint64
	var x24 uint64
	x24, x23 = bits.Mul64(x19, 0xb85045b68181585d)
	var x25 uint64
	var x26 uint64
	x26, x25 = bits.Mul64(x19, 0x2833e84879b97091)
	var x27 uint64
	var x28 uint64
	x28, x27 = bits.Mul64(x19, 0x43e1f593f0000001)
	var x29 uint64
	var x30 uint64
	...
	var x43 uint64
	var x44 uint64
	x44, x43 = bits.Mul64(x1, 0x216d0b17f4e44a5)
	var x45 uint64
	var x46 uint64
	x46, x45 = bits.Mul64(x1, 0x8c49833d53bb8085)
	var x47 uint64
	var x48 uint64
	x48, x47 = bits.Mul64(x1, 0x53fe3ab1e35c59e3)
	var x49 uint64
	var x50 uint64
	x50, x49 = bits.Mul64(x1, 0x1bb8e645ae216da7)
	var x51 uint64
	var x52 uint64
	...
	var x65 uint64
	_, x65 = bits.Mul64(x57, 0xc2e1f593efffffff)
	var x67 uint64
	var x68 uint64
	x68, x67 = bits.Mul64(x65, 0x30644e72e131a029)
	var x69 uint64
	var x70 uint64
	x70, x69 = bits.Mul64(x65, 0xb85045b68181585d)
	var x71 uint64
	var x72 uint64
	x72, x71 = bits.Mul64(x65, 0x2833e84879b97091)
	var x73 uint64
	var x74 uint64
	x74, x73 = bits.Mul64(x65, 0x43e1f593f0000001)
	var x75 uint64
	var x76 uint64
	...
	var x89 uint64
	var x90 uint64
	x90, x89 = bits.Mul64(x2, 0x216d0b17f4e44a5)
	var x91 uint64
	var x92 uint64
	x92, x91 = bits.Mul64(x2, 0x8c49833d53bb8085)
	var x93 uint64
	var x94 uint64
	x94, x93 = bits.Mul64(x2, 0x53fe3ab1e35c59e3)
	var x95 uint64
	var x96 uint64
	x96, x95 = bits.Mul64(x2, 0x1bb8e645ae216da7)
	var x97 uint64
	var x98 uint64
	...
	var x111 uint64
	_, x111 = bits.Mul64(x103, 0xc2e1f593efffffff)
	var x113 uint64
	var x114 uint64
	x114, x113 = bits.Mul64(x111, 0x30644e72e131a029)
	var x115 uint64
	var x116 uint64
	x116, x115 = bits.Mul64(x111, 0xb85045b68181585d)
	var x117 uint64
	var x118 uint64
	x118, x117 = bits.Mul64(x111, 0x2833e84879b97091)
	var x119 uint64
	var x120 uint64
	x120, x119 = bits.Mul64(x111, 0x43e1f593f0000001)
	var x121 uint64
	var x122 uint64
	...
	var x135 uint64
	var x136 uint64
	x136, x135 = bits.Mul64(x3, 0x216d0b17f4e44a5)
	var x137 uint64
	var x138 uint64
	x138, x137 = bits.Mul64(x3, 0x8c49833d53bb8085)
	var x139 uint64
	var x140 uint64
	x140, x139 = bits.Mul64(x3, 0x53fe3ab1e35c59e3)
	var x141 uint64
	var x142 uint64
	x142, x141 = bits.Mul64(x3, 0x1bb8e645ae216da7)
	var x143 uint64
	var x144 uint64
	...
	var x157 uint64
	_, x157 = bits.Mul64(x149, 0xc2e1f593efffffff)
	var x159 uint64
	var x160 uint64
	x160, x159 = bits.Mul64(x157, 0x30644e72e131a029)
	var x161 uint64
	var x162 uint64
	x162, x161 = bits.Mul64(x157, 0xb85045b68181585d)
	var x163 uint64
	var x164 uint64
	x164, x163 = bits.Mul64(x157, 0x2833e84879b97091)
	var x165 uint64
	var x166 uint64
	x166, x165 = bits.Mul64(x157, 0x43e1f593f0000001)
	var x167 uint64
	var x168 uint64
	...
	var x182 uint64
	var x183 uint64
	x182, x183 = bits.Sub64(x175, 0x43e1f593f0000001, uint64(0x0))
	var x184 uint64
	var x185 uint64
	x184, x185 = bits.Sub64(x177, 0x2833e84879b97091, uint64(uint1(x183)))
	var x186 uint64
	var x187 uint64
	x186, x187 = bits.Sub64(x179, 0xb85045b68181585d, uint64(uint1(x185)))
	var x188 uint64
	var x189 uint64
	x188, x189 = bits.Sub64(x181, 0x30644e72e131a029, uint64(uint1(x187)))
	var x191 uint64
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x39 uint64
	var x40 uint64
	x39, x40 = bits.Sub64(x31, 0x43e1f593f0000001, uint64(0x0))
	var x41 uint64
	var x42 uint64
	x41, x42 = bits.Sub64(x33, 0x2833e84879b97091, uint64(uint1(x40)))
	var x43 uint64
	var x44 uint64
	x43, x44 = bits.Sub64(x35, 0xb85045b68181585d, uint64(uint1(x42)))
	var x45 uint64
	var x46 uint64
	x45, x46 = bits.Sub64(x37, 0x30644e72e131a029, uint64(uint1(x44)))
	var x48 uint64
	...
	var x62 uint64
	var x63 uint64
	x62, x63 = bits.Add64(x53, (x61 & 0x43e1f593f0000001), uint64(0x0))
	var x64 uint64
	var x65 uint64
	x64, x65 = bits.Add64(x55, (x61 & 0x2833e84879b97091), uint64(uint1(x63)))
	var x66 uint64
	var x67 uint64
	x66, x67 = bits.Add64(x57, (x61 & 0xb85045b68181585d), uint64(uint1(x65)))
	var x68 uint64
	x68, _ = bits.Add64(x59, (x61 & 0x30644e72e131a029), uint64(uint1(x67)))
	var x70 uint64
	...
	var x102 uint64
	var x103 uint64
	x102, x103 = bits.Sub64(x94, 0x43e1f593f0000001, uint64(0x0))
	var x104 uint64
	var x105 uint64
	x104, x105 = bits.Sub64(x96, 0x2833e84879b97091, uint64(uint1(x103)))
	var x106 uint64
	var x107 uint64
	x106, x107 = bits.Sub64(x98, 0xb85045b68181585d, uint64(uint1(x105)))
	var x108 uint64
	var x109 uint64
	x108, x109 = bits.Sub64(x100, 0x30644e72e131a029, uint64(uint1(x107)))
	var x111 uint64

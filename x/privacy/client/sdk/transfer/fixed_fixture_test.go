...
func testFixedNote(n privacytypes.Note) privacytypes.SecretNoteV1 {
...
func testFixedFieldBig(v privacycrypto.FieldValue) *big.Int {
	b := v.Bytes()
	return new(big.Int).SetBytes(b[:])
}
func testFixedCommitment(n privacytypes.SecretNoteV1) *big.Int {
	v, err := privacytypes.SecretNoteCommitmentV1(n)
	if err != nil {
		panic(err)
	}
	return testFixedFieldBig(v)
}
func testFixedNullifier(n privacytypes.SecretNoteV1) *big.Int {

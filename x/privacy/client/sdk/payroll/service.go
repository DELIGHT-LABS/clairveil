		...
		for noteIndex, note := range item.InputNotes {
			...
			if noteIndex == 0 {
				reservationInput.Operation = &privacyreservation.PayrollOperation{
					...
					ExpectedUserDisclosureDigest:     item.DisclosurePolicy.ExpectedUserDisclosureDigest,
					ExpectedAuditDisclosureDigest:    expectedAuditDisclosureDigest(*item),
					ExpectedSelfViewDisclosureDigest: item.DisclosurePolicy.ExpectedSelfViewDisclosureDigest,

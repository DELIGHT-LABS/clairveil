...
func TestPreparedOutputUsesCanonicalStringAmount(t *testing.T) {
	...
	expected = []byte(strings.Replace(string(expected), `"am":`+output.Note.Amount.String()+`,`, `"am":"`+output.Note.Amount.String()+`",`, 1))
